 ...
 */
final class MistypedParameterDocblock implements IssueInterface, MistypedInterface, DocblockInterface
{
    ...
    public const MESSAGE_COMPACT = 'Incorrect parameter type in the docblock!';
}